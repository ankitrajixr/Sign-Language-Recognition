...
function [match1,match2,cx1,cy1,cx2,cy2,num]  = match(vv, image2, distRatio)
%close all;
match1=0;
match2=0;
cy1=0;
...
im1=cell2mat(im11(vv));
des1=cell2mat(des11(vv));
loc1=cell2mat(loc11(vv));



im1=imread(dataBase(vv,:)); %optional
